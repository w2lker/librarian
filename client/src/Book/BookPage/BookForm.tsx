    ...
    <form onSubmit={handleSubmit(processData)}>
      <div className="max-w-screen-lg mx-auto p-4 flex flex-wrap">
        <div className="w-full lg:w-1/3">
          {cover && <img src={cover} className="w-full h-auto shadow-md rounded-lg" alt="book cover" />}
          {!cover && <div className="placeholder  w-full h-72 rounded-xl bg-slate-200"></div>}
        </div>
                ...
                <tr>
                  ...
                  <td>
                    <Controller
                      name="skills"
                      control={control}
                      render={({ field }) => <SkillSelector defaultValue={[]} {...field} invalid={!!errors.skills?.message} />}
                    />
                  </td>
                </tr>
                <tr>
