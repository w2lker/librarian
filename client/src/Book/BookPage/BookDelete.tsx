...
export const BookDelete: React.FC<BookDeleteProps> = ({bookId, onDelete}) => {
  ...
  return (
    <>
      <button className="btn btn-outline btn-neutral mt-4 float-right" onClick={handleDeleteDialogOpen}>Delete book</button>
      <dialog id="book-delete-modal" className="modal">
        <div className="modal-box">
          <h3 className="font-bold text-lg">Removal confirmation</h3>
          <p className="py-4">You are about to permanently delete this book. Once deleted, this action cannot be undone. Please confirm your decision.</p>
